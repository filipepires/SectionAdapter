...
public class ElementDelegate extends AdapterDelegate {
    ...
    public ElementDelegate(Context context, int viewType) {
        super(viewType);
    ...
    public ViewHolderDelegate onCreateViewHolder(ViewGroup parent) {
        return new DelegateViewHolder(LayoutInflater.from(context).inflate(R.layout.delelgate_element, parent, false));
    }
