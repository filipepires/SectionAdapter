...
public class FooterDelegate extends AdapterDelegate {
    ...
    public FooterDelegate(Context context, int viewType) {
        super(viewType);
    ...
    public ViewHolderDelegate onCreateViewHolder(ViewGroup parent) {
        return new DelegateViewHolder(LayoutInflater.from(context).inflate(R.layout.delelgate_footer, parent, false));
    }
